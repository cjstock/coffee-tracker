        ...
        return <>
            <div className={`z-50 h-1/2 w-1/2 p-4 fixed bg-secondary ${isEditBeanVisible ? "visible" : "invisible"}`}>
                <Form>
                    ...
                    <Input type="text" placeholder="Region" value={data.region} />
                    <Select value={data.process}>
                    ...
                    <Input type="text" placeholder="Variety" value={data.variety} />
                    <Input type="text" placeholder="Altitude" value={data.altitude} />
                    <Input type="text" placeholder="Roast" value={data.roast} />
                    <Button>Save</Button>
                </Form>
            </div>
        </>
